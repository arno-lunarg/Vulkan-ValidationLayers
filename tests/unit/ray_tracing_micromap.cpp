...
class NegativeRayTracingMicromap : public RayTracingTest {
  ...
  protected:
    struct AccelStructTestResources {
        vkt::Buffer as_buffer;
        vkt::Buffer as_buffer1;
        vkt::Buffer scratch_buffer;
        vkt::Buffer micromap_buffer;
        vkt::Buffer triangle_buffer;
        vkt::Buffer invalid_buffer;
        VkAccelerationStructureGeometryKHR geometry;
        VkAccelerationStructureGeometryMicromapDataKHR micromap_data;
        std::array<VkAccelerationStructureGeometryKHR, 2> geometryArray;
        VkDeviceAddressRangeKHR micromapAddress;

        // Acceleration structure handles for different test scenarios:
        // - as: Built opacity micromap (VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR)
        // - unbuilt_as: Unbuilt opacity micromap (created but never built, for validation testing)
        // - as1, as2, as3: Bottom-level acceleration structures (BLAS) backed by as_buffer1
        //   Used for testing different BLAS configurations and update scenarios
        // - as4: BLAS backed by invalid_buffer (unbound memory, for memory validation testing)
        VkAccelerationStructureKHR as;
        VkAccelerationStructureCreateInfo2KHR asci;
        VkAccelerationStructureKHR unbuilt_as;
        VkAccelerationStructureCreateInfoKHR as_create_info;
        VkAccelerationStructureKHR as1;
        VkAccelerationStructureKHR as2;
        VkAccelerationStructureKHR as3;
        VkAccelerationStructureKHR as4;
        VkAccelerationStructureBuildGeometryInfoKHR build_info;
        VkAccelerationStructureBuildRangeInfoKHR range_info;
        const VkAccelerationStructureBuildRangeInfoKHR* pRangeInfo;
        const VkAccelerationStructureBuildRangeInfoKHR* pRangeNullInfo;
        VkAccelerationStructureTrianglesOpacityMicromapKHR triangleMicromap;
        VkDevice device = VK_NULL_HANDLE;

        AccelStructTestResources(NegativeRayTracingMicromap* test_fixture)
            : as(VK_NULL_HANDLE),
              unbuilt_as(VK_NULL_HANDLE),
              as1(VK_NULL_HANDLE),
              as2(VK_NULL_HANDLE),
              as3(VK_NULL_HANDLE),
              as4(VK_NULL_HANDLE) {
            test_fixture->SetupAccelStructTestResources(*this);
        }

        ~AccelStructTestResources() { Cleanup(); }

        void Cleanup() {
            if (device != VK_NULL_HANDLE) {
                if (as4 != VK_NULL_HANDLE) {
                    vk::DestroyAccelerationStructureKHR(device, as4, nullptr);
                    as4 = VK_NULL_HANDLE;
                }
                if (as3 != VK_NULL_HANDLE) {
                    vk::DestroyAccelerationStructureKHR(device, as3, nullptr);
                    as3 = VK_NULL_HANDLE;
                }
                if (as2 != VK_NULL_HANDLE) {
                    vk::DestroyAccelerationStructureKHR(device, as2, nullptr);
                    as2 = VK_NULL_HANDLE;
                }
                if (as1 != VK_NULL_HANDLE) {
                    vk::DestroyAccelerationStructureKHR(device, as1, nullptr);
                    as1 = VK_NULL_HANDLE;
                }
                if (unbuilt_as != VK_NULL_HANDLE) {
                    vk::DestroyAccelerationStructureKHR(device, unbuilt_as, nullptr);
                    unbuilt_as = VK_NULL_HANDLE;
                }
    ...
    void SetupAccelStructTestResources(AccelStructTestResources& resources) {
        ...
        resources.as_buffer =
            vkt::Buffer(*m_device, 4096,
                        VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR |
                            VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT,
                        VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &alloc_flags_info);

        resources.as_buffer1 =
            vkt::Buffer(*m_device, 4096,
                        VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR |
                            VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT,
                        VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &alloc_flags_info);

        resources.scratch_buffer =
            vkt::Buffer(*m_device, 4096,
                        VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR |
                            VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT |
        ...
        resources.micromap_buffer =
            vkt::Buffer(*m_device, 4096,
                        VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT |
                            VK_BUFFER_USAGE_STORAGE_BUFFER_BIT,
                        VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &alloc_flags_info);

        resources.triangle_buffer =
            vkt::Buffer(*m_device, 4096,
                        VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR |
        ...
        auto buffer_ci = vkt::Buffer::CreateInfo(
            4096, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR);
        resources.invalid_buffer = vkt::Buffer(*m_device, buffer_ci, vkt::no_mem);

        resources.geometry = vku::InitStructHelper();
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_MICROMAP_KHR;

        resources.micromap_data = vku::InitStructHelper();
        resources.micromap_data.data = resources.as_buffer.Address();
        resources.micromap_data.triangleArray = resources.as_buffer.Address();
        resources.micromap_data.triangleArrayStride = 8;

        resources.geometry.pNext = &resources.micromap_data;

        resources.geometryArray[0] = resources.geometry;
        resources.geometryArray[1] = resources.geometry;

        resources.micromapAddress.address = resources.as_buffer.Address();
        resources.micromapAddress.size = 4096;

        resources.asci = vku::InitStructHelper();
        resources.asci.addressRange = resources.micromapAddress;
        resources.asci.type = VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR;

        vk::CreateAccelerationStructure2KHR(device(), &resources.asci, NULL, &resources.as);

        vk::CreateAccelerationStructure2KHR(device(), &resources.asci, NULL, &resources.unbuilt_as);

        resources.as_create_info = vku::InitStructHelper();
        resources.as_create_info.buffer = resources.as_buffer1;
        resources.as_create_info.createFlags = 0;
        resources.as_create_info.offset = 0;
        resources.as_create_info.size = 4096;
        resources.as_create_info.type = VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR;
        resources.as_create_info.deviceAddress = 0;

        vk::CreateAccelerationStructureKHR(device(), &resources.as_create_info, NULL, &resources.as1);
        vk::CreateAccelerationStructureKHR(device(), &resources.as_create_info, NULL, &resources.as2);
        vk::CreateAccelerationStructureKHR(device(), &resources.as_create_info, NULL, &resources.as3);

        resources.as_create_info.buffer = resources.invalid_buffer.handle();
        vk::CreateAccelerationStructureKHR(device(), &resources.as_create_info, NULL, &resources.as4);

        resources.build_info = vku::InitStructHelper();
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR;
        resources.build_info.geometryCount = 1;
        resources.build_info.pGeometries = &resources.geometry;
        resources.build_info.mode = VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR;
        resources.build_info.srcAccelerationStructure = resources.as;
        resources.build_info.dstAccelerationStructure = resources.as;
        resources.build_info.scratchData.deviceAddress = resources.scratch_buffer.Address();

        resources.range_info = {};
        resources.range_info.primitiveCount = 1;
        resources.range_info.primitiveOffset = 0;
        resources.range_info.firstVertex = 0;
        resources.range_info.transformOffset = 0;

        resources.pRangeInfo = &resources.range_info;
        resources.pRangeNullInfo = NULL;
        resources.triangleMicromap = vku::InitStructHelper();
    }
};
...
TEST_F(NegativeRayTracingMicromap, CreateAccelerationStructureKHR) {
    ...
    vkt::Buffer buffer(*m_device, 4096, VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                       &alloc_flags);
    ...
    // invalid type in createInfo
    {
        VkAccelerationStructureCreateInfoKHR invalid_type_create_info = as_create_info;
        invalid_type_create_info.type = VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR;
        m_errorMonitor->SetDesiredError("VUID-VkAccelerationStructureCreateInfoKHR-type-11600");
        vk::CreateAccelerationStructureKHR(device(), &invalid_type_create_info, nullptr, &as);
        m_errorMonitor->VerifyFound();
    }
}

TEST_F(NegativeRayTracingMicromap, CreateAccelerationStructure2ReplayFeature) {
    ...
    asci.createFlags = VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR;

    m_errorMonitor->SetDesiredError("VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11673");
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureInvalidFlags) {
    TEST_DESCRIPTION("Validate invalid flags for micromap acceleration structures.");
    RETURN_IF_SKIP(InitMicromapTest());
    AccelStructTestResources resources(this);

    {
        m_command_buffer.Begin();
        resources.build_info.flags = VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR;
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR;
        ...
        vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &resources.build_info, &resources.pRangeInfo);
        m_errorMonitor->VerifyFound();
        m_command_buffer.End();
    }
    ...
    {
        m_command_buffer.Begin();
        resources.build_info.flags = VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_KHR;
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR;
        resources.build_info.srcAccelerationStructure = NULL;
        m_errorMonitor->SetDesiredError("VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11562");
        vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &resources.build_info, &resources.pRangeNullInfo);
        m_errorMonitor->VerifyFound();
        resources.build_info.flags &= ~VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_KHR;
        m_command_buffer.End();
    }
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureInvalidFlagsEXT) {
...

    {
        m_command_buffer.Begin();
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR;
        resources.build_info.srcAccelerationStructure = VK_NULL_HANDLE;
        resources.build_info.flags = VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_KHR |
        ...
        vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &resources.build_info, &resources.pRangeNullInfo);
        m_errorMonitor->VerifyFound();
        resources.build_info.flags = 0;
        m_command_buffer.End();
    }
}

TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureMode) {
    TEST_DESCRIPTION("Validate invalid mode and type for micromap acceleration structures.");
    RETURN_IF_SKIP(InitMicromapTest());
    AccelStructTestResources resources(this);

    {
        m_command_buffer.Begin();
        resources.build_info.mode = VK_BUILD_ACCELERATION_STRUCTURE_MODE_UPDATE_KHR;
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR;
        resources.build_info.srcAccelerationStructure = VK_NULL_HANDLE;
...

    {
        ...
        resources.build_info.mode = VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR;
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR;
        resources.build_info.srcAccelerationStructure = resources.unbuilt_as;
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureGeometry) {
    TEST_DESCRIPTION("Validate geometry requirements for micromap acceleration structures.");
    RETURN_IF_SKIP(InitMicromapTest());
...

    {
        ...
        triangle_geometry.geometry.triangles.vertexData.deviceAddress = resources.triangle_buffer.Address();
        resources.build_info.pGeometries = &triangle_geometry;
...

    {
        ...
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_MICROMAP_KHR;
        resources.geometry.pNext = &resources.micromap_data;
        resources.build_info.geometryCount = 2;
        resources.build_info.pGeometries = resources.geometryArray.data();
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureGeometryFlags) {
    TEST_DESCRIPTION("Validate geometry flag requirements for micromap acceleration structures.");
    RETURN_IF_SKIP(InitMicromapTest());
...

    {
        ...
        resources.build_info.srcAccelerationStructure = VK_NULL_HANDLE;
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_MICROMAP_KHR;
        resources.geometry.flags = VK_GEOMETRY_OPAQUE_BIT_KHR;
        resources.build_info.geometryCount = 1;
        resources.build_info.pGeometries = &resources.geometry;
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureMicromapData) {
    TEST_DESCRIPTION("Validate micromap data requirements for micromap acceleration structures.");
    RETURN_IF_SKIP(InitMicromapTest());
...

    {
        ...
        resources.build_info.srcAccelerationStructure = VK_NULL_HANDLE;
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_MICROMAP_KHR;
        resources.micromap_data.data = 0;
        resources.geometry.pNext = &resources.micromap_data;
        resources.build_info.geometryCount = 1;
        resources.build_info.pGeometries = &resources.geometry;
...

    {
        ...
        resources.build_info.srcAccelerationStructure = VK_NULL_HANDLE;
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_MICROMAP_KHR;
        resources.micromap_data.data = 0x1;
        resources.geometry.pNext = &resources.micromap_data;
        resources.build_info.geometryCount = 1;
        resources.build_info.pGeometries = &resources.geometry;
...

    {
        ...
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR;
        resources.build_info.srcAccelerationStructure = VK_NULL_HANDLE;
        resources.build_info.dstAccelerationStructure = resources.as2;
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_MICROMAP_KHR;
        resources.micromap_data.data = resources.micromap_buffer.Address();
        resources.micromap_data.triangleArray = resources.micromap_buffer.Address();
        resources.geometry.pNext = &resources.micromap_data;
        resources.build_info.geometryCount = 1;
        resources.build_info.pGeometries = &resources.geometry;
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureMicromapUsage) {
...

    {
        ...
        usage.count = 1024;
        usage.format = VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR;
        usage.subdivisionLevel = 1;
        m_command_buffer.Begin();
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR;
        resources.build_info.srcAccelerationStructure = VK_NULL_HANDLE;
        ...
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_MICROMAP_KHR;
        resources.micromap_data.data = resources.as_buffer.Address();
        resources.micromap_data.triangleArray = resources.triangle_buffer.Address();
        resources.micromap_data.triangleArrayStride = 8;
        resources.micromap_data.usageCountsCount = 1;
        resources.micromap_data.pUsageCounts = &usage;
        resources.micromap_data.ppUsageCounts = nullptr;
        resources.geometry.pNext = &resources.micromap_data;
        resources.build_info.geometryCount = 1;
        resources.build_info.pGeometries = &resources.geometry;
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureTriangleMicromap) {
    TEST_DESCRIPTION("Validate triangle micromap requirements for micromap acceleration structures.");
    RETURN_IF_SKIP(InitMicromapTest());
...

    {
        ...
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR;
        resources.build_info.srcAccelerationStructure = NULL;
        resources.build_info.dstAccelerationStructure = resources.as1;
        resources.geometry = vku::InitStructHelper();
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_TRIANGLES_KHR;
        resources.geometry.geometry.triangles = vku::InitStructHelper();
        resources.geometry.geometry.triangles.indexType = VK_INDEX_TYPE_NONE_KHR;
        resources.geometry.geometry.triangles.maxVertex = 3;
        resources.geometry.geometry.triangles.transformData.deviceAddress = resources.triangle_buffer.Address();
        resources.geometry.geometry.triangles.vertexData.deviceAddress = resources.triangle_buffer.Address();
        resources.geometry.geometry.triangles.vertexFormat = VK_FORMAT_R32G32B32_SFLOAT;
        resources.triangleMicromap.indexType = VK_INDEX_TYPE_NONE_KHR;
        resources.triangleMicromap.indexBuffer = resources.micromap_buffer.Address();
        resources.triangleMicromap.indexStride = 0;
        resources.triangleMicromap.micromap = NULL;
        resources.geometry.geometry.triangles.pNext = &resources.triangleMicromap;
        resources.build_info.pGeometries = &resources.geometry;
...

    {
        ...
        resources.build_info.type = VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR;
        resources.build_info.srcAccelerationStructure = NULL;
        resources.build_info.dstAccelerationStructure = resources.as3;
        resources.geometry.geometryType = VK_GEOMETRY_TYPE_TRIANGLES_KHR;
        resources.geometry.geometry.triangles = vku::InitStructHelper();
        resources.geometry.geometry.triangles.indexType = VK_INDEX_TYPE_NONE_KHR;
        resources.geometry.geometry.triangles.maxVertex = 3;
        ...
        resources.geometry.geometry.triangles.vertexData.deviceAddress = resources.triangle_buffer.Address();
        resources.geometry.geometry.triangles.vertexFormat = VK_FORMAT_R32G32B32_SFLOAT;
        resources.triangleMicromap.indexType = VK_INDEX_TYPE_UINT16;
        resources.triangleMicromap.indexBuffer = 0;
        resources.triangleMicromap.indexStride = 1;
        resources.triangleMicromap.micromap = resources.as3;
        resources.geometry.geometry.triangles.pNext = &resources.triangleMicromap;
        resources.build_info.pGeometries = &resources.geometry;
...

    {
        ...
        resources.geometry.geometry.triangles.vertexData.deviceAddress = resources.triangle_buffer.Address();
        resources.geometry.geometry.triangles.vertexFormat = VK_FORMAT_R32G32B32_SFLOAT;
        resources.triangleMicromap.indexType = VK_INDEX_TYPE_UINT32;
        resources.triangleMicromap.indexBuffer = resources.micromap_buffer.Address();
        resources.triangleMicromap.indexStride = UINT64_MAX;
        resources.triangleMicromap.micromap = resources.as;
        resources.geometry.geometry.triangles.pNext = &resources.triangleMicromap;
        resources.build_info.pGeometries = &resources.geometry;
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureTriangleMicromapIndexValidation) {
    TEST_DESCRIPTION("Validate triangle micromap index buffer range, triangle count, and special index requirements.");
    RETURN_IF_SKIP(InitMicromapTest());
    ...
    resources.geometry.geometry.triangles = vku::InitStructHelper();
    resources.geometry.geometry.triangles.indexType = VK_INDEX_TYPE_NONE_KHR;
    resources.geometry.geometry.triangles.maxVertex = 5;
    resources.geometry.geometry.triangles.transformData.deviceAddress = resources.triangle_buffer.Address();
    resources.geometry.geometry.triangles.vertexData.deviceAddress = resources.triangle_buffer.Address();
    resources.geometry.geometry.triangles.vertexFormat = VK_FORMAT_R32G32B32_SFLOAT;
    ...
    resources.range_info.primitiveCount = 2;

    {
        VkMemoryAllocateFlagsInfo alloc_flags_info = vku::InitStructHelper();
        alloc_flags_info.flags = VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT;
        vkt::Buffer small_index_buffer(
            *m_device, 4, VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT,
            VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &alloc_flags_info);
        resources.triangleMicromap = vku::InitStructHelper();
        resources.triangleMicromap.indexType = VK_INDEX_TYPE_UINT32;
        resources.triangleMicromap.indexBuffer = small_index_buffer.Address();
        resources.triangleMicromap.indexStride = 4;
        resources.triangleMicromap.baseTriangle = 0;
        resources.triangleMicromap.micromap = resources.as;
        resources.geometry.geometry.triangles.pNext = &resources.triangleMicromap;
        m_command_buffer.Begin();
...

    {
        ...
        resources.triangleMicromap.indexType = VK_INDEX_TYPE_NONE_KHR;
        resources.triangleMicromap.indexBuffer = 0;
        resources.triangleMicromap.baseTriangle = 2;
        resources.triangleMicromap.micromap = resources.as;
        resources.geometry.geometry.triangles.pNext = &resources.triangleMicromap;
        m_command_buffer.Begin();
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureTriangleMicromapEXT) {
    TEST_DESCRIPTION("Validate VkAccelerationStructureTrianglesOpacityMicromapEXT requirements.");
    RETURN_IF_SKIP(InitMicromapTest());
    AccelStructTestResources resources(this);
    ...
    VkAccelerationStructureTrianglesOpacityMicromapEXT triangleMicromapEXT = vku::InitStructHelper();
    triangleMicromapEXT.indexType = VK_INDEX_TYPE_NONE_KHR;
    triangleMicromapEXT.micromap = VK_NULL_HANDLE;
    resources.geometry.geometry.triangles.pNext = &triangleMicromapEXT;
    resources.build_info.pGeometries = &resources.geometry;

    {
        ...
        triangleMicromapEXT.pUsageCounts = &usage;
        triangleMicromapEXT.ppUsageCounts = &p_usage;
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureIndexType) {
    TEST_DESCRIPTION("Validate triangle micromap indexType for micromap acceleration structures.");
    RETURN_IF_SKIP(InitMicromapTest());
...

    {
        ...
        resources.geometry.geometry.triangles.vertexData.deviceAddress = resources.triangle_buffer.Address();
        resources.geometry.geometry.triangles.vertexFormat = VK_FORMAT_R32G32B32_SFLOAT;
        resources.triangleMicromap.indexType = VK_INDEX_TYPE_MAX_ENUM;
        resources.triangleMicromap.indexBuffer = resources.micromap_buffer.Address();
        resources.triangleMicromap.indexStride = 4;
        resources.triangleMicromap.micromap = resources.as;
        resources.geometry.geometry.triangles.pNext = &resources.triangleMicromap;
        ...
        m_errorMonitor->SetDesiredError("VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-indexType-parameter");
        m_errorMonitor->SetAllowedFailureMsg("VUID-vkCmdBuildAccelerationStructuresKHR-commandBuffer-cmdpool");
        vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &resources.build_info, &resources.pRangeInfo);
        m_errorMonitor->VerifyFound();
        m_command_buffer.End();
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructuresIndirectKHR) {
    ...
    VkDeviceAddress indirect_device_address = indirect_buffer_.Address();
    uint32_t stride = 8;
...
TEST_F(NegativeRayTracingMicromap, BuildAccelStructureFeatureNotPresent) {
    TEST_DESCRIPTION("Validate acceleration structure without feature.");
    ...
    const VkAccelerationStructureBuildRangeInfoKHR* pRangeNullInfo = NULL;
    ...
    // Invalid Flags
    {
        ...
        vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &build_info, &pRangeNullInfo);
        m_errorMonitor->VerifyFound();
        m_command_buffer.End();
    }
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructuresBuildSizesKHR) {
    TEST_DESCRIPTION("Validate acceleration structure build sizes.");
    RETURN_IF_SKIP(InitMicromapTest());
    ...
    std::array<VkMicromapUsageKHR, 1> micromap_usage;
    micromap_usage[0].count = 1;
    micromap_usage[0].format = VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR;
    micromap_usage[0].subdivisionLevel = 1;

    VkMicromapUsageKHR* pUsageCount = micromap_usage.data();
    micromap_data.pUsageCounts = micromap_usage.data();
    ...
    {
        micromap_usage[0].format = VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR;
        micromap_usage[0].subdivisionLevel = UINT32_MAX;
        micromap_usage[0].count = 1;
        micromap_data.pUsageCounts = micromap_usage.data();
        micromap_data.triangleArrayStride = 8;
    ...
    {
        micromap_data.pUsageCounts = micromap_usage.data();
        micromap_data.ppUsageCounts = &pUsageCount;
...

    {
        micromap_usage[0].format = VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR;
        micromap_usage[0].subdivisionLevel = 1;
        micromap_usage[0].count = UINT32_MAX;
        micromap_data.pUsageCounts = micromap_usage.data();
...
TEST_F(NegativeRayTracingMicromap, GetAccelerationStructureBuildSizes) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    RETURN_IF_SKIP(InitMicromapTest());
...

    {
        ...
        vk::GetAccelerationStructureBuildSizesKHR(device(), VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR, &build_info, nullptr,
                                                  &build_sizes_info);
        m_errorMonitor->VerifyFound();
    }
}
...
TEST_F(NegativeRayTracingMicromap, DISABLED_CopyMemoryToAccelerationStructureKHR) {
    TEST_DESCRIPTION("Validate vkCopyMemoryToAccelerationStructureKHR during deserialization");
    AddRequiredFeature(vkt::Feature::accelerationStructureHostCommands);
    RETURN_IF_SKIP(InitMicromapTest());
...

    {
        ...
        VkDeviceAddress invalid_micromap_address = resources.scratch_buffer.Address() + 8192;  // Address not pointing to a micromap
...
TEST_F(NegativeRayTracingMicromap, DISABLED_CopyMemoryToAccelerationStructureKHRFeatureDisabled) {
    TEST_DESCRIPTION("Validate vkCopyMemoryToAccelerationStructureKHR during deserialization without micromap feature");
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_DEVICE_ADDRESS_COMMANDS_EXTENSION_NAME);
...
TEST_F(NegativeRayTracingMicromap, CopyMemoryToFromAccelStructUnbound) {
    TEST_DESCRIPTION("Validate memory backing for vkCopyMemoryTo/FromAccelerationStructureKHR");
    AddRequiredFeature(vkt::Feature::accelerationStructureHostCommands);
    RETURN_IF_SKIP(InitMicromapTest());
...

    {
        ...
        resources.geometry.geometry.triangles.maxVertex = 3;
        resources.geometry.geometry.triangles.indexType = VK_INDEX_TYPE_NONE_KHR;
        resources.geometry.pNext = nullptr;
        vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &resources.build_info, &resources.pRangeInfo);
        m_command_buffer.End();
        m_default_queue->Submit(m_command_buffer);
        m_default_queue->Wait();
        ...
        m_errorMonitor->SetDesiredError("VUID-VkCopyAccelerationStructureToMemoryInfoKHR-mode-11715");
...

    {
        ...
        m_errorMonitor->SetDesiredError("VUID-VkCopyMemoryToAccelerationStructureInfoKHR-dst-11716");
        vk::CopyMemoryToAccelerationStructureKHR(device(), VK_NULL_HANDLE, &copy_info);
        m_errorMonitor->VerifyFound();
        vk::DestroyAccelerationStructureKHR(device(), as_unbound, nullptr);
    }
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelerationStructureUpdateMicromapConsistency) {
    TEST_DESCRIPTION("Validate micromap consistency during acceleration structure updates");
    RETURN_IF_SKIP(InitMicromapTest());
    ...
    resources.triangleMicromap.indexType = VK_INDEX_TYPE_NONE_KHR;
    resources.triangleMicromap.micromap = resources.as;
    triangle_geometry.geometry.triangles.pNext = &resources.triangleMicromap;
    ...
    blas_build_info.dstAccelerationStructure = resources.as1;
    blas_build_info.scratchData.deviceAddress = resources.scratch_buffer.Address();

    m_command_buffer.Begin();
    vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &blas_build_info, &resources.pRangeInfo);
    m_command_buffer.End();
    m_default_queue->Submit(m_command_buffer);
    m_default_queue->Wait();
    ...
    {
        m_command_buffer.Begin();
        resources.triangleMicromap.micromap = VK_NULL_HANDLE;
        resources.triangleMicromap.indexType = VK_INDEX_TYPE_UINT32;
        resources.triangleMicromap.indexBuffer = resources.micromap_buffer.Address();
        blas_build_info.mode = VK_BUILD_ACCELERATION_STRUCTURE_MODE_UPDATE_KHR;
        blas_build_info.srcAccelerationStructure = resources.as1;
...

    {
        ...
        blas_build_info.mode = VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR;
        blas_build_info.srcAccelerationStructure = VK_NULL_HANDLE;
        blas_build_info.dstAccelerationStructure = resources.as2;
        m_command_buffer.Begin();
        vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &blas_build_info, &resources.pRangeInfo);
        m_command_buffer.End();
        m_default_queue->Submit(m_command_buffer);
        ...
        m_command_buffer.Begin();
        resources.triangleMicromap.micromap = resources.unbuilt_as;
        blas_build_info.mode = VK_BUILD_ACCELERATION_STRUCTURE_MODE_UPDATE_KHR;
        blas_build_info.srcAccelerationStructure = resources.as2;
        blas_build_info.dstAccelerationStructure = resources.as2;
...
TEST_F(NegativeRayTracingMicromap, CmdBuildAccelStructureUpdateMicromapDeserialized) {
    TEST_DESCRIPTION("Validate micromap consistency for deserialized AS updates");
    AddRequiredFeature(vkt::Feature::accelerationStructureHostCommands);
    RETURN_IF_SKIP(InitMicromapTest());
    ...
    copy_to_mem_info.src = resources.as1;
    ...
    copy_from_mem_info.dst = resources.as2;
    copy_from_mem_info.mode = VK_COPY_ACCELERATION_STRUCTURE_MODE_DESERIALIZE_KHR;

    VkMemoryAllocateFlagsInfo alloc_flags = vku::InitStructHelper();
    alloc_flags.flags = VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT;
    vkt::Buffer separate_buffer(*m_device, 4096,
                                VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT,
...

    {
        ...
        blas_build_info.srcAccelerationStructure = resources.as2;
        blas_build_info.dstAccelerationStructure = resources.as2;
        m_errorMonitor->SetDesiredError("VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11628");
        vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &blas_build_info, &resources.pRangeInfo);
        m_errorMonitor->VerifyFound();
        m_command_buffer.End();
    }
...
TEST_F(NegativeRayTracingMicromap, BuildAccelStructInstanceMicromapFeatureDisabled) {
    TEST_DESCRIPTION("Validate VkAccelerationStructureInstancesKHR micromap flags require micromap feature.");
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_DEVICE_ADDRESS_COMMANDS_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_OPACITY_MICROMAP_EXTENSION_NAME);
    ...
    vk::BuildAccelerationStructuresKHR(device(), VK_NULL_HANDLE, 1, &build_info, &p_range_info);
    m_errorMonitor->VerifyFound();
}

TEST_F(NegativeRayTracingMicromap, BuildAccelStructInstanceDisableBuildFlag) {
    TEST_DESCRIPTION("Validate VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR required referenced AS build flag.");
    AddRequiredFeature(vkt::Feature::accelerationStructureHostCommands);
    RETURN_IF_SKIP(InitMicromapTest());
    ...
    blas_build_info.pGeometries = &triangle_geometry;
    blas_build_info.dstAccelerationStructure = resources.as1;
    blas_build_info.scratchData.hostAddress = resources.scratch_buffer.Memory().Map();
    ...
    resources.scratch_buffer.Memory().Unmap();

    VkAccelerationStructureInstanceKHR instance = {};
    instance.flags = VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR;
    instance.mask = 0xFF;
    instance.instanceShaderBindingTableRecordOffset = 0;
    instance.accelerationStructureReference = CastToUint64(resources.as1);
...
TEST_F(NegativeRayTracingMicromap, CmdCopyAccelStructToMemoryAlignment) {
    TEST_DESCRIPTION("vkCmdCopyAccelerationStructureToMemoryKHR src opacity micromap device address alignment.");
    RETURN_IF_SKIP(InitMicromapTest());
    ...
    misaligned_address_range.address = resources.as_buffer.Address() + 64;
    misaligned_address_range.size = 4096 - 64;

    VkAccelerationStructureCreateInfo2KHR misaligned_asci = vku::InitStructHelper();
    misaligned_asci.addressFlags = VK_ADDRESS_COMMAND_PROTECTED_BIT_KHR;
    ...
    resources.build_info.mode = VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR;
    resources.build_info.srcAccelerationStructure = VK_NULL_HANDLE;
    resources.build_info.dstAccelerationStructure = misaligned_micromap;
    m_command_buffer.Begin();
    vk::CmdBuildAccelerationStructuresKHR(m_command_buffer, 1, &resources.build_info, &resources.pRangeNullInfo);
    m_command_buffer.End();
    m_default_queue->Submit(m_command_buffer);
    ...
    dst_addr.deviceAddress = resources.scratch_buffer.Address();
...
TEST_F(NegativeRayTracingMicromap, DescriptorAccessDeserializedAS) {
    AddRequiredFeature(vkt::Feature::accelerationStructureHostCommands);
    RETURN_IF_SKIP(InitMicromapTest());
    ...
    copy_from_mem.dst = resources.as2;
    ...
    descriptor_set.WriteDescriptorAccelStruct(0, 1, &resources.as2);
...
TEST_F(NegativeRayTracingMicromap, DISABLED_TraceRaysOMMPipelineFlagMissing) {
    ...
    descriptor_set.WriteDescriptorAccelStruct(0, 1, &resources.as1);
    descriptor_set.UpdateDescriptorSets();
    ...
    VkMemoryAllocateFlagsInfo alloc_flags = vku::InitStructHelper();
    alloc_flags.flags = VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT;
    vkt::Buffer sbt_buffer(*m_device, aligned_handle_size,
